...
static void button_changed(uint32_t button_state, uint32_t has_changed)
{
	...
	if ((has_changed & USER_BUTTON_3) && (button_state & USER_BUTTON_3)) 
	{
		...
		{
		case 0:
			printk("Direction is now set to 0\n");
			break;
		case 1:
			printk("Direction is now set to 1\n");
			break;
		case 2:
			printk("Direction is now set to 2\n");
			break;
		case 3:
			printk("Direction is now set to 3\n");
			break;
		case 4:
			printk("Direction is now set to 4\n");
			break;
		case 5:
			printk("Direction is now set to 5\n");
			break;
...
void main(void)
{
	...
	//int result=calculateDistanceToAllCentrePointsAndSelectWinner(1613.0,1285.0,1636.0);
	//printk("here is the result: %d\n", result);
	}
}
